...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public ::  &  ! model size parameters
      POP_nxGlobal = 1200 ,&! extent of horizontal axis in i direction
      POP_nyGlobal = 800,&! extent of horizontal axis in j direction
      POP_km = 100          ,&! number of vertical levels
