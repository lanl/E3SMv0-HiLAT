!  SVN:$Id: ice_diagnostics.F90 1022 2015-07-01 18:15:05Z njeffery $
!=======================================================================
...
!          Nicole Jeffery, LANL
      ...
      use ice_colpkg_tracers, only: nt_sice, nt_fbri
...
!          Nicole Jeffery, LANL
      ...
      use ice_colpkg_tracers, only: nt_bgc_N, nt_bgc_C, nt_bgc_chl, nt_bgc_Am, &
...
!          Nicole Jeffery, LANL
      ...
      use ice_broadcast, only: broadcast_scalar, broadcast_array
      use ice_constants_colpkg, only: rhos, rhoi, rhow, c1
      ...
      use ice_colpkg_tracers, only: tr_brine, nt_fbri, nt_bgc_S, nt_sice
