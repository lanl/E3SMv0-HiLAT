...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_colpkg_tracers, only: nt_iage
...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_state, only: trcrn
      use ice_colpkg_tracers, only: nt_FY
...
!         David A. Bailey, NCAR
      ...
      use ice_state, only: trcrn
      use ice_colpkg_tracers, only: nt_apnd, nt_hpnd
...
! authors Elizabeth C. Hunke, LANL
      ...
      use ice_state, only: trcrn
      use ice_colpkg_tracers, only: nt_apnd, nt_hpnd, nt_ipnd
...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_state, only: trcrn
      use ice_colpkg_tracers, only: nt_fbri
...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_restart, only:  write_restart_field
      use ice_colpkg_tracers, only: nt_bgc_S, nt_bgc_Am, &
      ...
      use ice_colpkg_shared, only: skl_bgc, solve_zsal
...
! author Elizabeth C. Hunke, LANL
      ...
      use ice_colpkg_tracers, only: nt_bgc_S, nt_bgc_Am, &
          ...
          tr_bgc_DON, tr_bgc_Fe,  tr_zaero , tr_bgc_chl, &
          nt_bgc_hum, tr_bgc_hum
      use ice_colpkg_shared, only: skl_bgc
