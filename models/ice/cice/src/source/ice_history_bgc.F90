...
! 2012 Elizabeth Hunke split code from ice_history.F90
      ...
      use ice_kinds_mod
      use ice_constants
      use ice_colpkg_shared, only: max_aero, max_dic, max_doc, max_don, &
                        max_algae, max_fe
...
!=======================================================================
      ...
      use ice_colpkg_tracers, only: tr_zaero, tr_aero, tr_brine, &
      ...
      use ice_colpkg_shared, only: solve_zsal, skl_bgc, z_tracers
...
! write average ice quantities or snapshots
      ...
      use ice_colpkg_tracers, only:  nt_aero, nt_fbri, &
     ...
     use ice_colpkg_shared, only: skl_bgc, z_tracers, sk_l, R_C2N, R_chl2N
